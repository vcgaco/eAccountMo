        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    JevNo = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    JevAmount = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Jevs", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SpecialAccounts_Funds_FundId",
                        column: x => x.FundId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SpecialAccounts_FundId",
                table: "SpecialAccounts",
                column: "FundId");
        }
